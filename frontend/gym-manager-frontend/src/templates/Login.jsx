...
import { getAdminAuth, getSuperAdminAuth, getUserAuth } from "../api/auth.js";
...
export function LoginSuperAdmin(){
    ...
    const sendLogin = async (event) => {
        ...
        const authResult = await getSuperAdminAuth(formLoginAdmin);

        if (authResult.success === true) {
            navigate('/gym-365/super-admin/home');
        } else {
    ...
    <div className="d-flex flex-grow-1 justify-content-center align-items-center w-100">
        ...
        <form onSubmit={(event) =>sendLogin(event)} className="border rounded p-4">
            <div className="mb-4">
                <h2 className="text-center fs-3">Gym Super-Manager</h2>
