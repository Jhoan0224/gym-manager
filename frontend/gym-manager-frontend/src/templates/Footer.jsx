...
export function FooterAdmin() {
    ...
    return(
    <>        
    <footer className="bg-body-tertiary text-center p-2">
        <p className="m-auto p-1">© 2025 THE GYM 365 — Todos los derechos reservados.</p>
    </footer>
    </>
    )
}
...
export function FooterUser() {
    ...
    <footer className="mt-3">
        <div className="text-center">
            <h1 className="fs-5">THE GYM  -  FOOTER USER</h1>
        </div>
